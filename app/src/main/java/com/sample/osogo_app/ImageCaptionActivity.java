...
public class ImageCaptionActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            // 텍스트 변환 작업 실행
            ImageCaptionActivity.CaptionTask captionTask = new ImageCaptionActivity.CaptionTask();
    ...
    private class CaptionTask extends AsyncTask<Bitmap, Void, String> {
        // REST API
        private static final String API_URL = "https://oshmos.pythonanywhere.com/api/v2/caption_kr";
        ...
        protected void onPostExecute(String result) {
            ...
            tts = new TextToSpeech(ImageCaptionActivity.this, new TextToSpeech.OnInitListener() {
                @Override
